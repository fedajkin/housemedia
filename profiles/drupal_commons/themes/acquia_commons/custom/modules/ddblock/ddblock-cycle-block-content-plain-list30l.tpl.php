...
/*!
  * Dynamic display block module template: plain-list30l - content template
...
/**
 * @file
 * Dynamic display block module template: plain-list301 - content template
 *
 * Available variables:
...
<div id="ddblock-<?php print $delta ?>" class="ddblock-cycle-<?php print $custom_template ?> clear-block">
 <div class="container clear-block border">
  <div class="container-inner clear-block border">
   ...
   <?php endif; ?>
   <!-- slider content -->
   <div class="slider slider-<?php print $pager_position ?> clear-block border">
